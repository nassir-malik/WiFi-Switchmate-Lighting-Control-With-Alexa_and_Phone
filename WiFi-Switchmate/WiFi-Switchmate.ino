...
/*********************************/
//Change the GPIO
const int  switchMate= 16;
const int alexaSwitch =5;
int switchState;
/*********************************/
/*********************************/
...
void setup() {
  ...
  // Setup pin modes
  pinMode(switchMate, INPUT);
  pinMode(alexaSwitch, OUTPUT);
...
void startHttpServer() {
    ...
    HTTP.on("/upnp/control/basicevent1", HTTP_POST, []() {
     ...
     //Serial.println(request);
      ...
      switchState=digitalRead(switchMate);
      
     if(switchState==0){
      Serial.print("switch is off");
    }else{
      Serial.print("switch1 is on");
    }
    ...
    HTTP.on("/switch", HTTP_GET, []() {
      ...
      HTTP.send(200, "text/plain", "Switch is " + switchState);
    });
...
void turnOnSwitch() {
  if (switchState==1){
    digitalWrite(alexaSwitch, HIGH);
    delay(500);
    digitalWrite(alexaSwitch, LOW);
  }
}
void turnOffSwitch() {
      if (switchState==0){
